...
Based on the Metanorma CI generic-rake.yml workflow.

Tests individual gems separately.
...
* Gem selection: Choose which gem to release via dropdown
* Version control: Specify version bump type or use 'skip'
