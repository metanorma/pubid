...
pubid = Pubid::Iso::Identifier::Base.create(publisher: "ISO", number: 123)
pubid.to_s
...
[source,ruby]
----
pubid = Pubid::Iso::Identifier::Base.create(publisher: "ISO", copublisher: "IEC", number: 123)
pubid.to_s
...
[source,ruby]
----
pubid = Pubid::Iso::Identifier::Base.create(publisher: "ISO", type: "TR", number: 123)
pubid.to_s
...
[source,ruby]
----
pubid = Pubid::Iso::Identifier::Base.create(publisher: "ISO", stage: :WD, number: 123)
pubid.to_s
...
[source,ruby]
----
pubid = Pubid::Iso::Identifier::Base.create(publisher: "ISO", number: 123, part: 1)
pubid.to_s
...
[source,ruby]
----
pubid = Pubid::Iso::Identifier::Base.create(publisher: "ISO", number: 123, part: 1, stage: "DIS", iteration: 1)
pubid.to_s
...
[source,ruby]
----
> base = Pubid::Iso::Identifier::Base.create(publisher: "ISO", number: 123, part: 1, year: 2019)
> pubid = Pubid::Iso::Identifier::Base.create(type: :amd, number: 1, year: "2021", stage: "WD", base: base)
> pubid.to_s
=> "ISO 1234-1:2019/WD Amd 1:2021"

> base = Pubid::Iso::Identifier::Base.create(publisher: "ISO", number: 123, part: 1, year: 2019)
> pubid = Pubid::Iso::Identifier::Base.create(type: :cor, number: "1", year: "2021", stage: :WD, base: base)
> pubid.to_s
...
[source,ruby]
----
> base = Pubid::Iso::Identifier::Base.create(
  number: "8601",
  part: "1",
  year: 2019,
  edition: 1,
...
> pubid = Pubid::Iso::Identifier::Base.create(type: :amd, number: "1", year: "2021", stage: "DAM", base: base)
...
[source,ruby]
----
> pubid = Pubid::Iso::Identifier::Base.parse("ISO/FDIS 26000:2010(ru)")
> pubid.to_s(format: :ref_num_long, lang: :russian)
=> "ИСО/ОПМС 26000:2010(ru)"
> pubid = Pubid::Iso::Identifier::Base.parse("ISO/IEC Guide 71:2001(fr)")
...
[source,ruby]
----
> pubid = Pubid::Iso::Identifier::Base.parse("ISO/FDIS 26000:2010")
> pubid.typed_stage_abbrev
=> "FDIS"
> pubid.typed_stage_name
=> "Final Draft International Standard"

> pubid = Pubid::Iso::Identifier::Base.parse("ISO/FDTR 26000:2010")
> pubid.typed_stage_abbrev
=> "FDTR"
> pubid.typed_stage_name
=> "Final Draft Technical Report"

> pubid = Pubid::Iso::Identifier::Base.parse("ISO/WD TR 26000:2010")
> pubid.typed_stage_abbrev
=> "WD TR"
> pubid.typed_stage_name
