...
https://www.metanorma.org/blog/2022-01-09-nist-pubid/["Introducing NIST PubID, and the migration of publication identifiers"] on 2022-01-09.

For further details on the Metanorma work on the NIST PubID, refer to the
https://riboseinc.github.io/report-nist-pubid/["Ribose comments to Publication Identifier Syntax for NIST Technical Series Publications"]
document.
